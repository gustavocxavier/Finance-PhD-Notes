...
# Updated: June 2020                                       #
#                                                          #
# https://www.fredasongdrechsler.com/full-python-code/dgtw #
############################################################

# This code is written to replicate the characteristics-based benchmarks proposed by Daniel, Grinblatt,
# Titman and Wermers (1997), hence the short form DGTW benchmarks. In asset pricing literature, the
# DGTW benchmarks are widely used to measure the performance of institutional investors based on the
...
# New calculation
comp3['bm'] = np.where(comp3.me_comp>0, comp3.be / comp3.me_comp, np.nan)
